<%-- 
    Document   : cocina
    Created on : 27 may. 2024, 13:03:38
    Author     : ikere
--%>
...
<html>
    <head>
        ...
        <link href="CSS/cssCocina.css" rel="stylesheet" type="text/css"/>
                ...
                <div class="col-lg-1">
                    <div class="IM1">
                        <div class="card" style="width: 18rem;">
                            ...
                            <img src="IMG/servilletas_pequeñas.jpg" class="first-image">
                            <div class="card-body">
                                <a href="#" onclick="addCart()"><center>Add to cart</center></a>
                                <hr>
                                <center>
                                    <h5 class="card-title">servilletas pequeñas</h5>
                                </center>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-2">
                    <div class="IM2">
                        <div class="card" style="width: 18rem;">
                            ...
                            <img src="IMG/servilletas_grandes.jpg" class="first-image">
                            <div class="card-body">
                                <a href="#" onclick="addCart()"><center>Add to cart</center></a>
                                <hr>
                                <center>
                                    <h5 class="card-title">servilletas grandes</h5>
                                </center>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3">
                    <div class="IM3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <img src="IMG/mantel.jpg" class="first-image">
                            <div class="card-body">
                                <a href="#" onclick="addCart()"><center>Add to cart</center></a>
                                <hr>
                                <center>
