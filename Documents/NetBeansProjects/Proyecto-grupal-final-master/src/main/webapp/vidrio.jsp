<%-- 
    Document   : vidrio
    Created on : 27 may. 2024, 13:16:41
    Author     : ikere
--%>
...
<html>
    <head>
        ...
        <link href="CSS/cssVidrio.css" rel="stylesheet" type="text/css"/>
                ...
                <div class="col-lg-1">
                    <div class="IM1">
                        <div class="card" style="width: 18rem;">
                            ...
                            <img src="IMG/TazaG.jpg" class="first-image">
                            <div class="card-body">
                                <a href="#" onclick="addCart()"><center>Add to cart</center></a>
                                <hr>
                                <center>
                                    <h5 class="card-title">Jarra grande</h5>
                                </center>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-2">
                    <div class="IM2">
                        <div class="card" style="width: 18rem;">
                            ...
                            <img src="IMG/TazaM.jpg" class="first-image">
                            <div class="card-body">
                                <a href="#" onclick="addCart()"><center>Add to cart</center></a>
                                <hr>
                                <center>
                                    <h5 class="card-title">Jarra mediana</h5>
                                </center>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="IM3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <center>
                                    <h5 class="card-title">Jarra pequeña</h5>
                                </center>
                            </div>
                        </div>
                    </div>
