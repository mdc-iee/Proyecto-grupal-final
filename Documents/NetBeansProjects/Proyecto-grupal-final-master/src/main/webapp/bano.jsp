<%-- 
    Document   : bano.jsp
    Created on : 27 may. 2024, 12:42:43
    Author     : ikere
--%>
...
<html>
    <head>
        ...
        <link href="CSS/cssBano.css" rel="stylesheet" type="text/css"/>
                ...
                <div class="col-lg-1">
                    <div class="IM1">
                        <div class="card" style="width: 18rem;">
                            ...
                            <img src="IMG/basura.jpg" class="first-image">
                            <div class="card-body">
                                <a href="#" onclick="addCart()"><center>Add to cart</center></a>
                                <hr>
                                <center>
                                    <h5 class="card-title">bote de basura </h5>
                                </center>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-2">
                    <div class="IM2">
                        <div class="card" style="width: 18rem;">
                            ...
                            <img src="IMG/guantes.webp" class="first-image">
                            <div class="card-body">
                                <a href="#" onclick="addCart()"><center>Add to cart</center></a>
                                <hr>
                                <center>
                ...
                <div class="col-lg-3">
                    <div class="IM3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <img src="IMG/velas.jpg" class="first-image">
                            <div class="card-body">
                                <a href="#" onclick="addCart()"><center>Add to cart</center></a>
                                <hr>
                                <center>
                                    <h5 class="card-title"> velas aromaticas </h5>
                                </center>
                            </div>
                        </div>
                    </div>
