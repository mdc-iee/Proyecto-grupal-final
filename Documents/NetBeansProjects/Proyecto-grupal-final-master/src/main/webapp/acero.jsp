<%-- 
    Document   : acero
    Created on : 27 may. 2024, 13:22:28
    Author     : ikere
--%>
...
<html>
	...
	<link href="CSS/cssAcero.css" rel="stylesheet" type="text/css"/>
	<title> ACERO </title>
...
<div class="container">
  ...
  <img src="IMG/cazos.jpg" class="first-image">
  <div class="card-body">
    <a href="#" onclick="addCart()"><center>Add to cart</center></a>
    <hr>
    <center>
      <h5 class="card-title">cazos</h5>
    </center>
  </div>
</div>
</div>
  ...
  <img src="IMG/cuberteria_aceroinox.jpg" class="first-image">
  <div class="card-body">
    <a href="#" onclick="addCart()"><center>Add to cart</center></a>
    <hr>
    <center>
      <h5 class="card-title">cuberteria</h5>
    </center>
  </div>
</div>
</div>
  ...
  <img src="IMG/sartenes.jpg" class="first-image">
  <div class="card-body">
    <a href="#" onclick="addCart()"><center>Add to cart</center></a>
    <hr>
    <center>
      <h5 class="card-title">sartenes</h5>
    </center>
  </div>
</div>
</div>
